...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.rosochackiShopFormService
    ...
    this.rosochackiShopFormService.getCreditCardYears().subscribe((data) => {
      console.log('Retrieved credit card years: ' + JSON.stringify(data));
      this.creditCardYears = data;
    });

    //populate countries
    this.rosochackiShopFormService.getCountries().subscribe((data) => {
  ...
  getStates(formGroupName: string) {
    ...
    this.rosochackiShopFormService.getStates(countryCode).subscribe((data) => {
